...
import { type WorldSceneResult, type WorldSceneResultWithPack, type WorldStepResult } from './world-result.js';
/**
 ...
 * ```
 */
export declare function worldCreateScene(params: WorldSceneClientParams & {
    returnPack: true;
}): WorldSceneResultWithPack;
export declare function worldCreateScene(params: WorldSceneClientParams & {
    returnPack?: false | undefined;
}): WorldSceneResult;
export declare function worldCreateScene(params: WorldSceneClientParams): WorldSceneResult | WorldSceneResultWithPack;
/**
 ...
 * ```
 */
export declare function worldStep(params: WorldStepClientParams): WorldStepResult;
