import { type VlaClientRunParams, type VlaClientRunResult, type VlaEmbodimentSelection, type VlaHparams } from '@qvac/inference/surface';
/**
 ...
 * ```
 */
export declare function vla(params: VlaClientRunParams): Promise<VlaClientRunResult>;
/**
 ...
 */
export declare function vlaHparams(params: {
    modelId: string;
}): Promise<{
    hparams: VlaHparams;
 ...
 * ```
 */
export declare function vlaSetEmbodiment(params: {
    modelId: string;
    embodiment: VlaEmbodimentSelection;
}): Promise<{
    hparams: VlaHparams;
}>;
//# sourceMappingURL=vla.d.ts.map