import { type GetLoadedModelInfoParams, type LoadedModelInfo, type RPCOptions } from '@qvac/inference/surface';
/**
 ...
 * ```
 */
export declare function getLoadedModelInfo(params: GetLoadedModelInfoParams, rpcOptions?: RPCOptions): Promise<LoadedModelInfo>;
//# sourceMappingURL=get-loaded-model-info.d.ts.map