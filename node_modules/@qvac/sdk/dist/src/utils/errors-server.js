...
function normalizeContextOverflowArgs(sizesOrPromptTokens, modelIdOrCtxSize, causeOrModelId, cause, extraSizes) {
    if (typeof sizesOrPromptTokens === 'object' && sizesOrPromptTokens !== null) {
        return {
            ...sizesOrPromptTokens,
            modelId: modelIdOrCtxSize,
    ...
    return {
        ...
        ctxSize: modelIdOrCtxSize,
        modelId: causeOrModelId,
        cause,
 ...
 * overflow with no numbers). `modelId` is supplied by the server-side
 * handler that wraps the addon error.
 *
...
export class ContextOverflowError extends QvacErrorBase {
    ...
    ctxSize;
    modelId;
    constructor(sizesOrPromptTokens, modelIdOrCtxSize, causeOrModelId, cause, extraSizes) {
        const n = normalizeContextOverflowArgs(sizesOrPromptTokens, modelIdOrCtxSize, causeOrModelId, cause, extraSizes);
        ...
        if (n.promptTokens !== undefined)
            this.promptTokens = n.promptTokens;
        if (n.ctxSize !== undefined)
            this.ctxSize = n.ctxSize;
        if (n.modelId !== undefined)
            this.modelId = n.modelId;
        if (n.cachedTokens !== undefined)
            this.cachedTokens = n.cachedTokens;
        if (n.requiredTokens !== undefined)
            this.requiredTokens = n.requiredTokens;
    }
...
export class InvalidAudioInputError extends QvacErrorBase {
    constructor(details, cause) {
        super(createErrorOptions(SDK_SERVER_ERROR_CODES.INVALID_AUDIO_INPUT, details ? [details] : undefined, cause));
    }
}
