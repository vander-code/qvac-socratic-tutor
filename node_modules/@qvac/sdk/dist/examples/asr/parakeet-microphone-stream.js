...
import { startMicrophone } from '../audio/mic-input.js';
...
try {
    ...
    ffmpeg.stdout.on('data', (chunk) => session.write(chunk));
    console.log('▸ Listening... speak and pause to see transcripts. End-of-turn boundaries fire when the EOU model emits an <EOU> token.');
