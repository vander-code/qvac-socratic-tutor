...
const systemPrompt = {
    role: 'system',
    content: "You are a concise travel assistant. Keep track of the user's preferences across turns."
};
...
try {
    ...
    const firstUserMessage = {
        role: 'user',
        content: 'I am planning a weekend in Lisbon. I prefer museums, seafood, and walking routes. Suggest a day plan in 3 bullets.'
    };
    ...
    await runCachedCompletion({
        ...
        history: [
            ...
            {
                role: 'user',
                content: 'Now revise the plan for a rainy day, but keep the same preferences.'
            }
        ]
    });
    await runCachedCompletion({
        ...
        history: [
            ...
            {
                role: 'user',
                content: 'I am planning a weekend in Berlin. I prefer nightlife and late starts. Suggest a day plan in 3 bullets.'
            }
        ]
    });
    console.log('\n▸ Summary:');
    ...
    console.log('▸ - Use deleteCache({ kvCacheKey: "your-session" }) to clear a saved session.');
    await deleteCache({ kvCacheKey: sharedCacheKey });
    await deleteCache({ kvCacheKey: isolatedCacheKey });
