...
test(
  '_readImage rejects GIF format with UNSUPPORTED_IMAGE_FORMAT',
...
test(
  '_readImage rejects WebP format with UNSUPPORTED_IMAGE_FORMAT',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
    // WebP: RIFF....WEBP
...
test(
  '_readImage rejects TIFF format with UNSUPPORTED_IMAGE_FORMAT',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test('_readImage rejects zero-byte file', { timeout: TEST_TIMEOUT }, async function (t) {
  ...
  try {
    ...
    t.is(
      ...
      'Error code should be INVALID_IMAGE_OR_INSUFFICIENT_DATA'
    )
...
test(
  '_readImage rejects file with less than 4 bytes',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  '_readImage correctly detects JPEG by magic bytes',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
...
test(
  '_readImage correctly detects PNG by magic bytes',
  { timeout: TEST_TIMEOUT },
  async function (t) {
    const onnxOcr = createOcrInstance()
