...
import type { DisposableScope } from './disposable-scope.js';
import { createRequestRegistry as createRegistry, type RequestRegistry } from './request-registry.js';
 ...
 */
export type RequestKind = 'completion' | 'batchCompletion' | 'embeddings' | 'transcribe' | 'translate' | 'diffusion' | 'world' | 'audiogen' | 'tts' | 'ocr' | 'vla' | 'finetune' | 'loadModel' | 'downloadAsset' | 'rag';
/**
...
export declare function getRequestRegistry(): RequestRegistry;
 ...
 */
export declare function withRequestContext(logger: Logger, ctx: RequestLogContext): Logger;
