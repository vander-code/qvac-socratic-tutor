...
export const attachmentSchema = z.object({
    path: z
        .string()
        .describe('Absolute or resolvable path to the attachment file (e.g., image for multimodal models).')
});
...
const completionClientParamsBaseSchema = completionParamsSchema.extend({
    ...
    toolDialect: toolDialectSchema
        .optional()
        .describe('Override auto-detected tool-call dialect. Use when name-based detection picks the wrong parser chain for your model.'),
