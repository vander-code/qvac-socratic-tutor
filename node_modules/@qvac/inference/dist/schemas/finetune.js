...
export const finetuneRunRequestSchema = finetuneRunParamsSchemaBase
    ...
    requestId: z
        ...
        .min(1)
        .optional()
        .describe('Stable identifier for this in-flight finetune, generated by the caller at call time. Surfaces on the registry so callers can target it with `cancel({ requestId })`. Optional — falls back to a generated id when the field is missing.')
})
    .strict()
