import { textToSpeechStreamResponseSchema } from '../schemas/index.js';
import Buffer from 'bare-buffer';
import { stream as streamRpc, duplex } from '../dispatch.js';
import { getAppLogger } from '../logging/index.js';
import { TextToSpeechStreamFailedError } from '../errors/index.js';
...
export async function textToSpeechStream(params, options) {
    ...
    return {
        write(textFragment) {
            ...
            const buf = typeof textFragment === 'string' ? Buffer.from(textFragment, 'utf8') : textFragment;
