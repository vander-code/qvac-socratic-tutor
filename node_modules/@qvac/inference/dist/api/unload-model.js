import { send, close } from '../dispatch.js';
import { stopLoggingStreamForModel } from './logging-stream-registry.js';
import { InvalidResponseError, ModelUnloadFailedError } from '../errors/index.js';
...
export async function unloadModel(params) {
    ...
    if (shouldAutoClose && response.hasActiveModels === false) {
        logger.info('🧹 No models active, automatically tearing down the engine...');
        await close();
    }
}
