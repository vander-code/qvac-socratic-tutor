module.exports = class HTTPParserError extends Error {
  ...
  static HEADER_OVERFLOW(msg = 'HTTP headers too large') {
    return new HTTPParserError(msg, HTTPParserError.HEADER_OVERFLOW)
  }

  static INVALID_METHOD(msg = 'Invalid HTTP method') {
    return new HTTPParserError(msg, HTTPParserError.INVALID_METHOD)
  }
