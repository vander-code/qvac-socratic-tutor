module.exports = class ModuleTraverseError extends Error {
  ...
  static AMBIGUOUS_MODULE_TYPE(msg) {
    return new ModuleTraverseError(msg, ModuleTraverseError.AMBIGUOUS_MODULE_TYPE)
  }

  static UNKNOWN_DATA_URL_MEDIA_TYPE(msg) {
    return new ModuleTraverseError(msg, ModuleTraverseError.UNKNOWN_DATA_URL_MEDIA_TYPE)
  }
